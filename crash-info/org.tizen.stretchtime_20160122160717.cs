...
r6   = 0x00000009, r7   = 0xbeb20dfc
r8   = 0x4059c25c, r9   = 0x40451824
r10  = 0x41c15000, fp   = 0x00000000
ip   = 0x4059a920, sp   = 0xbeb20d78
...
41b20000 41b25000 rw-p [heap]
41b25000 41c57000 rw-p [heap]
41c57000 41d3b000 r-xp /usr/lib/libicuuc.so.51.1
41d50000 41e08000 r-xp /usr/lib/libcairo.so.2.11200.14
...
4399d000 4419c000 rwxp [stack:20217]
...
442d6000 44ad5000 rwxp [stack:20224]
beb01000 beb22000 rwxp [stack]
End of Maps Information

Callstack Information (PID:20119)
Call Stack Count: 2
...
ient.c: make_direct_connection(2077) > [SECURE_LOG] Failed to create a connection
01-22 16:07:24.009+0900 W/AUL_AMD (  527): amd_request.c: __request_handler(640) > __request_handler: 14
01-22 16:07:24.019+0900 W/AUL_AMD (  527): amd_request.c: __send_result_to_client(83) > __send_result_to_client, pid: 20278
01-22 16:07:24.019+0900 W/AUL_AMD (  527): amd_request.c: __request_handler(640) > __request_handler: 12
01-22 16:07:24.084+0900 W/AUL_AMD (  527): amd_request.c: __request_handler(640) > __request_handler: 14
01-22 16:07:24.089+0900 W/AUL_AMD (  527): amd_request.c: __send_result_to_client(83) > __send_result_to_client, pid: 20278
01-22 16:07:24.089+0900 W/AUL_AMD (  527): amd_request.c: __request_handler(640) > __request_handler: 12
01-22 16:07:24.094+0900 E/WIDGET_VIEWER(  713): widget.c: widget_viewer_has_glance_bar(1890) > [SECURE_LOG] Handler is invalid
01-22 16:07:24.124+0900 I/CAPI_WATCH_APPLICATION(20278): watch_app_main.c: watch_app_main(382) > watch_app_main
01-22 16:07:24.174+0900 E/TBM     (20278): tbm_bufmgr.c: _tbm_bufmgr_init_state(674) > USE TGL LOCK!
01-22 16:07:24.219+0900 W/WATCH_CORE(20278): appcore-watch.c: __widget_create(958) > widget_create
01-22 16:07:24.219+0900 E/watchface-loader(20278): watchface-loader.cpp: OnAppCreated(502) > 
01-22 16:07:24.219+0900 I/MESSAGE_PORT(  446): MessagePortIpcServer.cpp: OnConnectionRequest(411) > _MessagePortIpcServer::OnConnectionRequest
01-22 16:07:24.219+0900 E/WIDGET_VIEWER(  717): client.c: master_created(1712) > [SECURE_LOG] [9372.019531] pkgname: com.samsung.watchface, id: file:///opt/usr/share/live_magazine/com.samsung.watchface_713_9372.019531.png, content: , gbar_w: 0, gbar_h: 0, widget_w: 360, widget_h: 360, cluster: user,created, category: default, widget_fname: "pixmap://0:0", gbar_fname: "", auto_launch: , priority: 0.000000, size_list: 4, user: 0, pinup: 0, widget_type: 4, gbar_type: 0, period: 0.000000, title: [], is_pinned_up: 0
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  717): fb.c: fb_is_created(425) > [SECURE_LOG] access: 2 ((null))
01-22 16:07:24.224+0900 E/WIDGET_EVAS(  717): widget_viewer_evas.c: __widget_resize(5435) > [SECURE_LOG] Failed to get box size
01-22 16:07:24.224+0900 E/WIDGET_EVAS(  717): widget_viewer_evas.c: __widget_resize(5449) > [SECURE_LOG] System created Widget is not able to be resized (com.samsung.watchface)
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  717): fb.c: fb_is_created(425) > [SECURE_LOG] access: 2 ((null))
01-22 16:07:24.224+0900 W/W_CLOCK_VIEWER(  717): clock-viewer-dbox.c: __clock_viewer_widget_raw_event_cb(48) >  DBOX Created[com.samsung.watchface] it should be [com.samsung.watchface]
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  717): fb.c: fb_is_created(425) > [SECURE_LOG] access: 2 ((null))
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  717): widget.c: widget_viewer_set_visibility(3853) > [SECURE_LOG] CA Livebox is not able to change the visibility
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  713): client.c: master_created(1712) > [SECURE_LOG] [9372.019531] pkgname: com.samsung.watchface, id: file:///opt/usr/share/live_magazine/com.samsung.watchface_713_9372.019531.png, content: , gbar_w: 0, gbar_h: 0, widget_w: 360, widget_h: 360, cluster: user,created, category: default, widget_fname: "pixmap://0:0", gbar_fname: "", auto_launch: , priority: 0.000000, size_list: 4, user: 1, pinup: 0, widget_type: 4, gbar_type: 0, period: 0.000000, title: [], is_pinned_up: 0
01-22 16:07:24.224+0900 W/W_HOME  (  713): dbox.c: _widget_created_cb(238) > widget resume:0x49feb048
01-22 16:07:24.224+0900 E/WIDGET_VIEWER(  713): fb.c: fb_is_created(425) > [SECURE_LOG] access: 2 ((null))
01-22 16:07:24.234+0900 I/MESSAGE_PORT(  446): MessagePortStub.cpp: OnIpcClientConnected(172) > MessagePort Ipc connected
01-22 16:07:24.234+0900 I/MESSAGE_PORT(  446): MessagePortIpcServer.cpp: OnConnectionRequest(411) > _MessagePortIpcServer::OnConnectionRequest
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortIpcServer.cpp: OnReadMessage(739) > _MessagePortIpcServer::OnReadMessage
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortIpcServer.cpp: HandleReceivedMessage(578) > _MessagePortIpcServer::HandleReceivedMessage
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortStub.cpp: OnIpcRequestReceived(147) > MessagePort message received
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortStub.cpp: OnRegisterMessagePort(91) > _MessagePortStub::OnRegisterMessagePort.
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortService.cpp: RegisterMessagePort(83) > _MessagePortService::RegisterMessagePort
01-22 16:07:24.239+0900 I/MESSAGE_PORT(  446): MessagePortService.cpp: GetKey(365) > _MessagePortService::GetKey
01-22 16:07:24.244+0900 I/MESSAGE_PORT(  446): MessagePortService.cpp: RegisterMessagePort(95) > Register a message port: [com.samsung.watchface:watchface::messageport::event], client = 20278
01-22 16:07:24.244+0900 I/MESSAGE_PORT(  446): MessagePortIpcServer.cpp: Send(847) > _MessagePortIpcServer::Stop
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_value_bool(484) > Enter [system_settings_get_value_bool]
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_value(386) > Enter [system_settings_get_value]
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(361) > Enter [system_settings_get_item], key=14
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(374) > Enter [system_settings_get_item], index = 14, key = 14, type = 2
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_unset_changed_cb(571) > Enter [system_settings_unset_changed_cb]
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(361) > Enter [system_settings_get_item], key=14
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(374) > Enter [system_settings_get_item], index = 14, key = 14, type = 2
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_set_changed_cb(534) > Enter [system_settings_set_changed_cb]
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(361) > Enter [system_settings_get_item], key=14
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(374) > Enter [system_settings_get_item], index = 14, key = 14, type = 2
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_unset_changed_cb(571) > Enter [system_settings_unset_changed_cb]
01-22 16:07:24.244+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(361) > Enter [system_settings_get_item], key=16
01-22 16:07:24.249+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(374) > Enter [system_settings_get_item], index = 16, key = 16, type = 1
01-22 16:07:24.249+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_set_changed_cb(534) > Enter [system_settings_set_changed_cb]
01-22 16:07:24.249+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(361) > Enter [system_settings_get_item], key=16
01-22 16:07:24.249+0900 E/TIZEN_N_SYSTEM_SETTINGS(20278): system_settings.c: system_settings_get_item(374) > Enter [system_settings_get_item], index = 16, key = 16, type = 1
01-22 16:07:24.389+0900 I/DALI    (20278): slp-logging.cpp: LogMessage(36) > EGL Information
01-22 16:07:24.389+0900 I/DALI    (20278):             Vendor:        ARM
01-22 16:07:24.389+0900 I/DALI    (20278):             Version:       1.4 Linux-r4p0-00rel0
01-22 16:07:24.389+0900 I/DALI    (20278):             Client APIs:   OpenGL_ES
01-22 16:07:24.389+0900 I/DALI    (20278):             Extensions:    EGL_KHR_image EGL_KHR_image_base EGL_KHR_image_pixmap EGL_KHR_gl_texture_2D_image EGL_KHR_gl_texture_cubemap_image EGL_KHR_gl_renderbuffer_image EGL_KHR_reusable_sync EGL_KHR_fence_sync EGL_EXT_swap_buffers_with_damage EGL_TIZEN_image_native_buffer EGL_TIZEN_image_native_surface EGL_KHR_lock_surface EGL_KHR_lock_surface2 EGL_EXT_create_context_robustness EGL_SEC_swapbuffers_region 
01-22 16:07:24.399+0900 I/watchface-viewer(20278): viewer-shader-manager.cpp: DisableShaderEffect(500) > not enabled effect type!! [1]
01-22 16:07:24.399+0900 I/watchface-viewer(20278): viewer-shader-manager.cpp: DisableShaderEffect(500) > not enabled effect type!! [2]
01-22 16:07:24.399+0900 I/watchface-viewer(20278): viewer-view.cpp: View(96) > default camera z[720.000000]
01-22 16:07:24.434+0900 E/BASE_UTILS(20278): utils_i18n_ucalendar.c: i18n_ucalendar_get_timezone_displayname(113) > (calendar == NULL || result == NULL || buf_size_needed == NULL)
01-22 16:07:24.434+0900 I/watchface-viewer(20278): viewer-util.cpp: ToUTF8(1214) > i18n_ustring_to_UTF8 returns -22(ffffffea)
01-22 16:07:24.434+0900 I/watchface-viewer(20278): viewer-data-provider.cpp: UpdateTimezone(2782) > timezonePath[Asia/Seoul] mTimezone[]
01-22 16:07:24.434+0900 I/watchface-viewer(20278): viewer-impl.cpp: SetDummyMode(95) > dummyMode[3]
01-22 16:07:24.434+0900 I/watchface-viewer(20278): viewer-data-provider.cpp: UpdateTimestamp(1310) > now[1453446444] dummy[1453425040]
01-22 16:07:24.449+0900 I/watchface-viewer(20278): viewer-model.cpp: ParseXML(669) > schema version[0.0]
01-22 16:07:24.449+0900 I/watchface-viewer(20278): viewer-model.cpp: ParseXML(689) > wrong target resolution!!
01-22 16:07:24.454+0900 I/watchface-viewer(20278): viewer-util.cpp: GetAppId(61) > appId[com.samsung.watchface]
...
01-22 16:07:25.999+0900 W/CRASH_MANAGER(20014): worker.c: worker_job(1199) > 1120119737472145344643
